...
## To Do
* check spread: some of the duplicate values are showing up as NA
...
mean_temp_2m<- group_by(profile2m, uid)%>%
  summarise(result=mean(temp_field, na.rm = TRUE))
    mean_temp_2m$parameter<-'mean_temp_2m'
      mean_temp_2m #1239
