...
# check that all VISIT_ID are unique
names(i07)[order(names(i07))]
nrow(i07) #1252
nrow(select(i07,VISIT_ID)%>%distinct()) #1252

#get the data structure file
struc<-read1('data/workfiles/','nla_sites-and-nla_samples.csv')
```
